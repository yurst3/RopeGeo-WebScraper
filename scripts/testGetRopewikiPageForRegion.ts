...
/**
 * Script to test getRopewikiPageForRegion: loads regions for the regionNameIds mapping,
...
async function main() {
    ...
    try {
        ...
        console.log(`Calling getRopewikiPageForRegion("World", offset=${offset}, limit=${LIMIT})`);
        const pages = await getRopewikiPageForRegion('World', offset, LIMIT, regionNameIds);
