...
3. Download and install [Docker](https://docs.docker.com/desktop) (For running database tests)
4. (Optional, Recommended) Download and install a database browser of your choice. Personally I recommend [DBeaver](https://dbeaver.io/)
...
`npm run test-db:stop` - Stops and deletes the "test-db" docker container
