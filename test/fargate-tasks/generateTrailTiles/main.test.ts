...
import { uploadTilesToS3 } from '../../../src/fargate-tasks/generateTrailTiles/s3/uploadTilesToS3';
...
jest.mock('../../../src/fargate-tasks/generateTrailTiles/s3/uploadTilesToS3', () => ({ uploadTilesToS3: jest.fn() }));
jest.mock('../../../src/fargate-tasks/generateTrailTiles/cloudfront/invalidateCloudFrontCache', () => ({
