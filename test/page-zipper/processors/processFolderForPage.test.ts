...
jest.mock('../../../src/page-zipper/processors/persistFolderZip', () => ({
    persistFolderZip: jest.fn(),
}));

import {
    processFolderForPage,
} from '../../../src/page-zipper/processors/processFolderForPage';
import type { FolderSourceLoop } from '../../../src/page-zipper/processors/processSourceFolders';
import { persistFolderZip } from '../../../src/page-zipper/processors/persistFolderZip';
