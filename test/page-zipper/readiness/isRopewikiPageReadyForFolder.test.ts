...
jest.mock('../../../src/page-zipper/database/getRopewikiPageForFolderReadiness', () => ({
    getRopewikiPageForFolderReadiness: jest.fn(),
}));
jest.mock('../../../src/page-zipper/database/countUnprocessedRopewikiImagesForPage', () => ({
    countUnprocessedRopewikiImagesForPage: jest.fn(),
}));
jest.mock('../../../src/page-zipper/database/getMapDataForFolderReadiness', () => ({
...
import { isRopewikiPageReadyForFolder } from '../../../src/page-zipper/readiness/isRopewikiPageReadyForFolder';
import { getRopewikiPageForFolderReadiness } from '../../../src/page-zipper/database/getRopewikiPageForFolderReadiness';
import { countUnprocessedRopewikiImagesForPage } from '../../../src/page-zipper/database/countUnprocessedRopewikiImagesForPage';
import { getMapDataForFolderReadiness } from '../../../src/page-zipper/database/getMapDataForFolderReadiness';
