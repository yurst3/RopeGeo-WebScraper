...
jest.mock('../../../src/page-zipper/zip/appendTileEntriesToArchive', () => ({
    appendTileEntriesToArchive: jest.fn(),
}));
jest.mock('../../../src/page-zipper/zip/buildRegionRoutesGeoJson', () => ({
...
import { appendTileEntriesToArchive } from '../../../src/page-zipper/zip/appendTileEntriesToArchive';
import { buildRegionRoutesGeoJson } from '../../../src/page-zipper/zip/buildRegionRoutesGeoJson';
