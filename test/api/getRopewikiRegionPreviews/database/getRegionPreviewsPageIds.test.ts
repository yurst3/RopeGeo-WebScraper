...
import { RopewikiRegionPreviewsParams } from 'ropegeo-common/models';
import {
...
describe('getRegionPreviewsPageIds (integration)', () => {
    ...
    it('returns only direct children (pages in region + child regions) ordered by quality (sort_key DESC, type ASC, id ASC)', async () => {
        ...
        await db
            .insert('RopewikiPage', {
                id: page1Id,
                externalPageId: 'region-previews-page-1',
        ...
        await db
            .insert('RopewikiPage', {
                id: page2Id,
                externalPageId: 'region-previews-page-2',
    ...
    it('respects limit and returns hasMore when more rows exist', async () => {
        ...
        for (let i = 0; i < 5; i++) {
            ...
            await db
                .insert('RopewikiPage', {
                    id: pageId,
                    externalPageId: `region-previews-limit-page-${i}`,
