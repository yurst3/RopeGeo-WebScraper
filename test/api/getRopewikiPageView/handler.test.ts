...
describe('getRopewikiPageView handler', () => {
    ...
    it('returns 200 and RopewikiPageView with CORS headers', async () => {
        ...
        const mockView: RopewikiPageView = {
            ...
            quality: 4.5,
            userVotes: 12,
            difficultyRating: { technical: '3', water: 'A', time: 'II', additionalRisk: null },
            permit: PermitStatus.No,
            rappelCount: new MinMax(5, 5),
            jumps: null,
            vehicle: null,
            rappelLongest: new LengthMeasurement(195, FEET),
            shuttleTime: null,
            overallTime: new MinMax(
                new TimeMeasurement(3.75, HOURS),
                new TimeMeasurement(4.9, HOURS),
            ),
            overallLength: null,
            approachTime: null,
            descentTime: null,
