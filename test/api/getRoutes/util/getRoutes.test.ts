...
import { PageDataSource, Route, RoutesParams, RouteType } from 'ropegeo-common';
...
describe('getRoutes util', () => {
    ...
    it('calls getAllRoutes when params.region is null', async () => {
        const params = new RoutesParams(undefined, undefined);
    ...
    it('calls getRopewikiRegionRoutes when params.region is set with source Ropewiki', async () => {
        ...
        const params = new RoutesParams(PageDataSource.Ropewiki, regionId);
