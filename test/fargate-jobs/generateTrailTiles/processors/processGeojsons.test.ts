...
import { writeGeojsonFile } from '../../../../src/fargate-jobs/generateTrailTiles/util/writeGeojsonFile';

jest.mock('fs', () => ({ mkdirSync: jest.fn() }));
jest.mock('../../../../src/fargate-jobs/generateTrailTiles/util/getFeaturesForGeojson', () => ({
    getFeaturesForGeojson: jest.fn(),
}));
jest.mock('../../../../src/fargate-jobs/generateTrailTiles/util/writeGeojsonFile', () => ({
